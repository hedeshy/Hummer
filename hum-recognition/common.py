...
SHARED_PATH: str = r'./shared' # artifacts shared among the scripts
...
def compute_feature_vector(y: np.array, sr: int) -> List[float]:
	...
	# Go over bins and concatenate features
	...
	for i in range(0, BIN_COUNT):
		...
		# chroma_stft = librosa.feature.chroma_stft(y=b, sr=sr) # too heavy computation
		# chroma_cqt = librosa.feature.chroma_cqt(y=b, sr=sr) # too heavy computation
	...
	return list(fts) # could return numpy array
